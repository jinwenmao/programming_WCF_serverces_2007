...
namespace ServiceModelEx
{
   ...
   {
      bool m_TransactionFlowEnabled;
      bool m_WCFOnly;
      bool m_ReliabilityRequired;

      public bool ReliabilityRequired
      {
         get
         {
            return m_ReliabilityRequired;
         }
         set
         {
            m_ReliabilityRequired = value;
         }
      }
      ...
      public bool TransactionFlowEnabled
      {
         get
         {
            return m_TransactionFlowEnabled;
         }
         set
         {
            m_TransactionFlowEnabled = value;
         }
      }
