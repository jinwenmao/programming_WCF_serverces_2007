...
namespace ServiceModelEx
{
   public static class ErrorHandlerHelper
   {
      ...
      {
         string assemblyName = error.TargetSite.Module.Assembly.GetName().Name;
         string fileName = GetFileName(error);
         int lineNumber = GetLineNumber(error);
         string typeName = error.TargetSite.DeclaringType.Name;
         string methodName = error.TargetSite.Name;
